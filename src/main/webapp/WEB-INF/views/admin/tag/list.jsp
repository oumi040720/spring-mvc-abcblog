...
<html>
	<head>
		...
		<title>Admin | <s:message code="tag.title" /></title>
					...
					<div class="row align-items-center">
						<div class="col-sm-6">
							<div class="breadcrumbs-area clearfix">
								<h4 class="page-title pull-left"><s:message code="tag.title" /></h4>
								<ul class="breadcrumbs pull-left">
									<li><a href=""><s:message code="tag.title" /></a></li>
									<li><span><s:message code="tag.list" /></span></li>
								</ul>
							</div>
						</div>
						...
						<div class="col-12 mt-5">
							<div class="card">
								...
								<div class="card-body">
									...
									<div class="row">
										<form id="form-submit" action="<c:url value="/admin/tag/list" />" method="get" style="width: 100%">
											<table class="table table-bordered datatable-dark">
												 <thead class="text-capitalize">
												 	<tr>
												 		<th><s:message code="tag.post" /></th>
												 		<th><s:message code="tag.category" /></th>
												 ...
												 <tbody>
														<c:forEach items="${tags}" var="tag">
															<tr>
																...
																<td>
																	<p>${tag.createBy} - ${tag.createDate}</p>
																</td>
																<td>
																	<p>${tag.modifiedBy} - ${tag.modifiedDate}</p>
																</td>
																<td>
																	<span class="mr-3">
																		<c:url var="editURL" value="/admin/tag/edit">
