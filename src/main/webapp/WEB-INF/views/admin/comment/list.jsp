						...
						<div class="col-sm-6">
							<div class="breadcrumbs-area clearfix">
								...
								<ul class="breadcrumbs pull-left">
									...
									<li><span><s:message code="comment.list" /></span></li>
								</ul>
							</div>
						</div>
						...
						<div class="col-12 mt-5">
							<div class="card">
								<div class="card-header">
									<h4><s:message code="comment.list" /></h4>
								</div>
								<div class="card-body">
									<div class="row">
										<a href="<c:url value="/admin/comment/add" />" class="btn btn-primary">
											<s:message code="comment.add" />
										</a>
									</div>
									<br>
									...
									<div class="row">
										<form id="form-submit" action="<c:url value="/admin/comment/list" />" method="get" style="width: 100%">
											<table class="table table-bordered datatable-dark">
												 <thead class="text-capitalize">
												 	<tr>
												 		<th style="width: 5%;"><s:message code="comment.post" /></th>
												 		<th><s:message code="comment.content" /></th>
												 ...
												 <tbody>
														<c:forEach items="${comments}" var="comment">
															<tr>
																...
																<td>
																	<p>${comment.createBy} - ${comment.createDate}</p>
																</td>
																<td>
																	<p>${comment.modifiedBy} - ${comment.modifiedDate}</p>
																</td>
																<td>
																	<span class="mr-3">
																		<c:url var="editURL" value="/admin/comment/edit">
																	...
																	<span class="mr-3">
																		<c:url var="deleteURL" value="/admin/comment/delete" >
																			<c:param name="id" value="${comment.id}" />
																		</c:url>
