						...
						<div class="col-sm-6">
							<div class="breadcrumbs-area clearfix">
								...
								<ul class="breadcrumbs pull-left">
									...
									<li><span><s:message code="category.edit" /></span></li>
								</ul>
							</div>
						</div>
								...
								<div class="card-header">
									<c:choose>
										<c:when test="${not empty category.id}">
											<h4><s:message code="category.update" /></h4>
										</c:when>
										<c:otherwise>
											<h4><s:message code="category.add" /></h4>
										</c:otherwise>
									</c:choose>
								</div>
								<div class="card-body">
									<div class="row">
										...
										<form:form action="${action}" modelAttribute="category" cssStyle="width: 100%;">
											<div class="form-group">
												<label><s:message code="category.name" />:</label>
												<form:input path="categoryName" cssClass="form-control"/>
											</div>
											<div class="form-group">
												<label><s:message code="category.code" />:</label>
